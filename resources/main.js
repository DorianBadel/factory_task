...
var isDisabledForward = false; //I am using *2 because i wan't the second array to be my starting position

var arrayWidthTop = calculateWidthTop() * 2;
var arrayWidthBottom = calculateWidthBottom() * 2; //Setting up the starting position
